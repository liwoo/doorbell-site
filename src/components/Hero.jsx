        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-12">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-100">
              ...
              and above. */}
              Starting from <strong>April 21st, 2024</strong>, Doorbell&apos;s
              App will be available for download on both Android and iOS
              devices. Our Beta Testing Program is currently oversubscribed.
              Please keep checking with us for more details.
            </p>
