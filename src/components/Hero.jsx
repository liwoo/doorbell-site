        ...
        <AppScreen>
            <AppScreen.Body>
                ...
                <section className="flex border-t border-gray-300 mt-6">
                    {
                        services.map(svc => <div onMouseOver={() => setToOrder(svc.name)} key={svc.name}
                                                 className="w-1/3 py-4 [&:nth-child(2)]:border-r [&:nth-child(2)]:border-l hover:bg-gray-100 cursor-pointer">
                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-12 mt-12">
                    <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 527 36" className="w-1/2">
                            <path stroke="#FFE45C" strokeLinecap="round" strokeWidth="14"
