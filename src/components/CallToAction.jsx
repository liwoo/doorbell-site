      ...
      <Container className="relative">
        <div className="">
          ...
          <h3 className="mt-4 text-2xl text-gray-100">
            and more in the Doorbell Zatheka App
          </h3>
          <div className="mt-4 flex">
            <Button href={'/about'} variant="outline" color="gray">
              Find out More
            </Button>
          </div>
          <Image
          ...
          <Image
            ...
            src={tomatoImage}
            alt="Tomatoes"
            width={windowWidth * 0.08 + 80}
            height={400}
          />
          <svg
            className="absolute left-2/3 top-1/4 z-10 w-8 xl:top-20 xl:-mx-28 xl:w-16"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 90 98"
          >
