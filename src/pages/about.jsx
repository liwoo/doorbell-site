                            ...
                            <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
                                <figure className="mt-10 border-l border-indigo-600 pl-9">
                                    <blockquote className="font-semibold text-gray-900">
                                        <p>Since our inception in 2019, we've been dedicated to simplifying daily routines.
                                            Whether it's delivering food, medications, or beverages, we meet approximately
                                ...
                                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                                    ...
                                    <li className="flex gap-x-3">
                                        <span>Starting with just four motorbikes, we've expanded our fleet to 18. This growth has been fueled, in part, by the increasing demand for convenience in the wake of the Covid-19 pandemic.</span>
                                    </li>
                                    <li className="flex gap-x-3">
                                ...
                                <p className="mt-6">Here's what's cooking: we're not just planning to expand our fleet; we're talking about revolutionizing the whole game. Picture an ecosystem where you don’t just get your grub and gadgets delivered, but also essential services that reach your doorstep faster than you can say 'Doorbell.' Our promise goes beyond rapid growth</p>
                                <p className="mt-6">We’re also looking at partnerships that can bring in cutting-edge tech to the delivery business, all to make your life not just easier, but better. So when you think about hitting that 'Order' button, know that you're not just getting a delivery—you're becoming part of a movement that's about to reshape convenience, service, and employment in Malawi.</p>
                            </div>
