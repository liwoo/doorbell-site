        ...
        <div className="bg-white px-6 py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
            ...
            <p className="mt-6 text-xl leading-8">
              ...
              application, Doorbell. By accessing or using our Service, you
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <ul className="ml-8 mt-4 flex list-disc flex-col gap-y-4">
                ...
                <li>
                  ...
                  “our,” it refers to Doorbell Malawi Limited, Lilongwe, Malawi
                  that is responsible for your information under this Privacy
                  Policy.
                </li>
                <li>
                  Country: where Doorbell or the owners/founders of Doorbell are
                  based, in this case is Malawi
                </li>
                <li>
                  Customer:&nbsp;refers to the company, organization or person
                  that signs up to use the Doorbell Service to manage the
                ...
                <li>
                  ...
                  by Doorbell or are under contract to perform a service on
                ...
                <li>
                  Service: refers to the service provided by Doorbell as
                ...
                <li>
                  Website: Doorbell&rsquo;s site, which can be accessed via this
                  URL:
                </li>
                <li>
                  You: a person or entity that is registered with Doorbell to
                  use the Services.
                </li>
              </ul>
            </div>
            ...
            <div className="mt-10 max-w-2xl">
              <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                When does Doorbell use end user information from third parties?
              </h1>
              <p>
                Doorbell will collect End User Data necessary to provide the
                Doorbell services to our customers.
              </p>
              <br />
              <p>
            ...
            <div className="mt-10 max-w-2xl">
              <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                When does Doorbell use customer information from third parties?
              </h1>
              <p>
                We receive some information from the third parties when you
                contact us. For example, when you submit your email address to
                us to show interest in becoming a Doorbell customer, we receive
                information from a third party that provides automated fraud
                detection services to Doorbell. We also occasionally collect
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                Doorbell will collect personal information that you submit to
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                Doorbell to you and fulfill the purposes described in this
                ...
                depersonalize it so that we can&rsquo;t identify you.
              </p>
            </div>
            <div className="mt-10 max-w-2xl">
              <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
              ...
              <p>
                ...
                Doorbell or guarantee that your information on the Service may
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                Doorbell is incorporated in Malawi. Information collected via
            ...
            <div className="mt-10 max-w-2xl">
              <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                Is the information collected through the Doorbell Service
                secure?
              </h1>
              <p>
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                information Doorbell collects depend on your relationship with
                Doorbell. Personnel may update or correct their information as
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                If you are a Doorbell worker or applicant, we collect
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                substantially all of the assets of Doorbell or any of its
                Corporate Affiliates (as defined herein), or that portion of
                Doorbell or any of its Corporate Affiliates to which the Service
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                by or is under common control with Doorbell, whether by
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                This Privacy Policy is governed by the laws of Malawi without
              ...
              <br />
              <p>
                The laws of Malawi, excluding its conflicts of law rules, shall
              ...
              <br />
              <p>
                By using Doorbell or contacting us directly, you signify your
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                site and how it&rsquo;s being used. By using our app,
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                by Doorbell. We are not responsible for the content, accuracy or
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                third party sites. Doorbell does not make any representation as
                to the accuracy or suitability of any of the information
                contained in those advertisements or sites and does not accept
                any responsibility or liability for the conduct or content of
                those advertisements and sites and the offerings made by the
                third parties.
              </p>
              <br />
              <p>
                Advertising keeps Doorbell and many of the websites and services
              ...
              <p>
                ...
                recommendations by Doorbell of the third party sites, goods or
                services. Doorbell takes no responsibility for the content of
                any of the ads, promises made, or the quality/reliability of the
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                Doorbell uses &quot;Cookies&quot; to identify the areas of our
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                all of its features and services. You should also be aware that
                you may also lose some saved information (e.g. saved login
                details, site preferences) if you block cookies on your browser.
                ...
                within your browser, you should visit your browser&rsquo;s help
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <br />
              <p>
                You acknowledge and agree that Doorbell shall not be responsible
                for any Third-Party Services, including their accuracy,
                completeness, timeliness, validity, copyright compliance,
                legality, decency, quality or any other aspect thereof. Doorbell
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                regulates how EU residents&rsquo; data is protected by companies
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <p>
                ...
                facts it&rsquo;s simply the right thing to do. At Doorbell we
            ...
            <div className="mt-10 max-w-2xl">
              <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                Individual Data Subject&rsquo;s Rights - Data Access,
                Portability and Deletion
              </h1>
              <p>
                We are committed to helping our customers meet the data subject
                rights requirements of GDPR. Doorbell processes or stores all
            ...
            <div className="mt-10 max-w-2xl">
              ...
              <ul className="ml-8 mt-4 flex list-disc flex-col gap-y-4">
                <li>
                  Via Email:{' '}
                  <Link href={'mailto:cto@doorbell.mw'}>cto@doorbell.mw</Link>
                </li>
                <li>
                  Via Phone Number:{' '}
