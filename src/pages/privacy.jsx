            ...
            <div className="bg-white px-6 py-32 lg:px-8">
                <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                    ...
                    <p className="mt-6 text-xl leading-8">
                        ...
                        “Service”) alongside our application, Doorbell. By accessing or using our Service, you signify
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Definition and
                            Key Terms</h1>
                        ...
                        <ul className="mt-4 gap-y-4 flex flex-col ml-8 list-disc">
                            ...
                            <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to
                                Doorbell Malawi Limited, Lilongwe, Malawi that is responsible for your information under
                                this Privacy Policy.
                            </li>
                            <li>Country: where Doorbell or the owners/founders of Doorbell are based, in this case is
                                Malawi
                            </li>
                            <li>Customer:&nbsp;refers to the company, organization or person that signs up to use the
                                Doorbell Service to manage the relationships with your consumers or service users.
                            </li>
                            <li>Device:&nbsp;any internet connected device such as a phone, tablet, computer or any
                                other device that can be used to visit Doorbell and use the services.
                            </li>
                            ...
                            <li>Personnel:&nbsp;refers to those individuals who are employed by Doorbell or are under
                            ...
                            <li>Service: refers to the service provided by Doorbell as described in the relative terms
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">What
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">How Do We Use The Information We Collect?</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">When does Doorbell use end user information from third parties?</h1>
                        <p>Doorbell will collect End User Data necessary to provide the Doorbell services to our customers.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">When does Doorbell use customer information from third parties?</h1>
                        <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Doorbell customer, we receive information from a third party that provides automated fraud detection services to Doorbell. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Do we share the information we collect with third parties?</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>Doorbell will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">How Do We Use Your Email Address?</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to Doorbell or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Could my information be transferred to other countries?</h1>
                        <p>Doorbell is incorporated in Malawi. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Is the information collected through the Doorbell Service secure?</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Can I update or correct my information?</h1>
                        <p>The rights you have to request updates or corrections to the information Doorbell collects depend on your relationship with Doorbell. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Personnel</h1>
                        <p>If you are a Doorbell worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Sale of Business</h1>
                        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Doorbell or any of its Corporate Affiliates (as defined herein), or that portion of Doorbell or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by Doorbell. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Advertising</h1>
                        <p>This app may contain third party advertisements and links to third party sites. Doorbell does not make any representation as to the accuracy or suitability of any of the information contained in those advertisements or sites and does not accept any responsibility or liability for the conduct or content of those advertisements and sites and the offerings made by the third parties.</p>
                        <br />
                        <p>Advertising keeps Doorbell and many of the websites and services you use free of charge. We work hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
                        <br />
                        <p>Third party advertisements and links to other sites where goods or services are advertised are not endorsements or recommendations by Doorbell of the third party sites, goods or services. Doorbell takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the products or services offered in all advertisements.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Cookies for Advertising</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Changes To Our Privacy Policy</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Information about General Data Protection Regulation (GDPR)</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">What is personal data?</h1>
