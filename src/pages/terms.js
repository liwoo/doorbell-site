        ...
        <MainLayout title={"Terms | Doorbell - Zonse Momo App"}>
            <div className="bg-white px-6 py-32 lg:px-8">
                <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                    ...
                    <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">General Terms</h1>
                    <p className="mt-6 text-xl leading-8">By accessing and placing an order with Doorbell, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and Doorbell.</p>
                    <p className="mt-6 text-xl leading-8">Under no circumstances shall Doorbell team be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the inability to use, the materials on this site, even if Doorbell team or an authorized representative has been advised of the possibility of such damages. If your use of materials from this site results in the need for servicing, repair or correction of equipment or data, you assume any costs thereof.</p>
                    <p className="mt-6 text-xl leading-8">Doorbell will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to change prices and revise the resources usage policy in any moment.</p>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">License</h1>
                        <p>Doorbell grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use the app strictly in accordance with the terms of this Agreement.</p>
                        <br />
                        <p>These Terms & Conditions are a contract between you and Doorbell (referred to in these Terms & Conditions as &quot;Doorbell&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;), the provider of the Doorbell website and the services accessible from the Doorbell website (which are collectively referred to in these Terms & Conditions as the &quot;Doorbell Service&quot;).</p>
                        <br />
                        <p>You are agreeing to be bound by these Terms & Conditions. If you do not agree to these Terms & Conditions, please do not use the Doorbell Service. In these Terms & Conditions, &quot;you&quot; refers both to you as an individual and to the entity you represent. If you violate any of these Terms & Conditions, we reserve the right to cancel your account or block access to your account without notice.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Definitions and key terms</h1>
                        ...
                        <ul className="mt-4 gap-y-4 flex flex-col ml-8 list-disc">
                            ...
                            <li>Company: when this policy mentions &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our,&quot; it refers to Doorbell Malawi Limited, Lilongwe, Malawi that is responsible for your information under this Terms &amp; Conditions.</li>
                            <li>Country: where Doorbell or the owners/founders of Doorbell are based, in this case is </li>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Restrictions</h1>
                        ...
                        <ul className="mt-4 gap-y-4 flex flex-col ml-8 list-disc">
                            ...
                            <li>Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of Doorbell or its affiliates, partners, suppliers or the licensors of the app.</li>
                        </ul>
                    </div>
                    <div className="mt-10 max-w-2xl">
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>Any feedback, comments, ideas, improvements or suggestions (collectively, &quot;Suggestions&quot;) provided by you to Doorbell with respect to the app shall remain the sole and exclusive property of Doorbell.</p>
                        <br />
                        <p>Doorbell shall be free to use, copy, modify, publish, or redistribute the Suggestions for any purpose and in any way without any credit or any compensation to you.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>This Terms & Conditions applies only to the Services. The Services may contain links to other websites not operated or controlled by Doorbell. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Terms & Conditions are no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Cookies</h1>
                        <p>Doorbell uses &quot;Cookies&quot; to identify the areas of our website that you have visited. A Cookie is a small piece of data stored on your computer or mobile device by your web browser. We use Cookies to enhance the performance and functionality of our app but are non-essential to their use. However, without these cookies, certain functionality like videos may become unavailable or you would be required to enter your login details every time you visit the app as we would not be able to remember that you had logged in previously. Most web browsers can be set to disable the use of Cookies. However, if you disable Cookies, you may not be able to access functionality on our website correctly or at all. We never place Personally Identifiable Information in Cookies.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Changes To Our Terms & Conditions</h1>
                        <p>You acknowledge and agree that Doorbell may stop (permanently or temporarily) providing the Service (or any features within the Service) to you or to users generally at sole discretion, without prior notice to you. You may stop using the Service at any time. You do not need to specifically inform Doorbell when you stop using the Service. You acknowledge and agree that if Doorbell disables access to your account, you may be prevented from accessing the Service, your account details or any files or other materials which is contained in your account.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Modifications to Our app</h1>
                        <p>Doorbell reserves the right to modify, suspend or discontinue, temporarily or permanently, the app or any service to which it connects, with or without notice and without liability to you.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Updates to Our app</h1>
                        <p>Doorbell may from time to time provide enhancements or improvements to the features/ functionality of the app, which may include patches, bug fixes, updates, upgrades and other modifications (&quot;Updates&quot;).</p>
                        <br />
                        <p>Updates may modify or delete certain features and/or functionalities of the app. You agree that Doorbell has no obligation to (i) provide any Updates, or (ii) continue to provide or enable any particular features and/or functionalities of the app to you.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>This Agreement shall remain in effect until terminated by you or Doorbell.</p>
                        <br />
                        <p>Doorbell may, in its sole discretion, at any time and for any or no reason, suspend or terminate this Agreement with or without prior notice.</p>
                        <br />
                        <p>This Agreement will terminate immediately, without prior notice from Doorbell, in the event that you fail to comply with any provision of this Agreement. You may also terminate this Agreement by deleting the app and all copies thereof from your computer.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Limitation of Liability</h1>
                        <p>Notwithstanding any damages that you might incur, the entire liability of Doorbell and any of its suppliers under any provision of this Agreement and your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by you for the app.</p>
                        <br />
                        <p>To the maximum extent permitted by applicable law, in no event shall Doorbell or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, for loss of data or other information, for business interruption, for personal injury, for loss of privacy arising out of or in any way related to the use of or inability to use the app, third-party software and/or third-party hardware used with the app, or otherwise in connection with any provision of this Agreement), even if Doorbell or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>
                        <br />
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Intellectual Property</h1>
                        <p>The app and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are owned by Doorbell, its licensors or other providers of such material and are protected by and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws. The material may not be copied, modified, reproduced, downloaded or distributed in any way, in whole or in part, without the express prior written permission of Doorbell, unless and except as is expressly provided in these Terms & Conditions. Any unauthorized use of the material is prohibited.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p>In the event of a dispute, you or Doorbell must give the other a Notice of Dispute, which is a written statement that sets forth the name, address, and contact information of the party giving it, the facts giving rise to the dispute, and the relief requested. You must send any Notice of Dispute via email to: <Link href={"mailto:support@doorbell.mw"}>support@doorbell.mw</Link>. Doorbell will send any Notice of Dispute to you by mail to your address if we have it, or otherwise to your email address. You and Doorbell will attempt to resolve any dispute through informal negotiation within sixty (60) days from the date the Notice of Dispute is sent. After sixty (60) days, you or Doorbell may commence arbitration.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Binding Arbitration</h1>
                        <p>If you and Doorbell don’t resolve any dispute by informal negotiation, any other effort to resolve the dispute will be conducted exclusively by binding arbitration as described in this section. You are giving up the right to litigate (or participate in as a party or class member) all disputes in court before a judge or jury. The dispute shall be settled by binding arbitration in accordance with the commercial arbitration rules of the American Arbitration Association. Either party may seek any interim or preliminary injunctive relief from any court of competent jurisdiction, as necessary to protect the party’s rights or property pending the completion of arbitration. Any and all legal, accounting, and other costs, fees, and expenses incurred by the prevailing party shall be borne by the non-prevailing party.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Submissions and Privacy</h1>
                        <p>In the event that you submit or post any ideas, creative suggestions, designs, photographs, information, advertisements, data or proposals, including ideas for new or improved products, services, features, technologies or promotions, you expressly agree that such submissions will automatically be treated as non-confidential and non-proprietary and will become the sole property of Doorbell without any compensation or credit to you whatsoever. Doorbell and its affiliates shall have no obligations with respect to such submissions or posts and may use the ideas contained in such submissions or posts for any purposes in any medium in perpetuity, including, but not limited to, developing, manufacturing, and marketing products and services using such ideas.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Promotions</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Typographical Errors</h1>
                    ...
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Miscellaneous</h1>
                        <p>If for any reason a court of competent jurisdiction finds any provision or portion of these Terms & Conditions to be unenforceable, the remainder of these Terms & Conditions will continue in full force and effect. Any waiver of any provision of these Terms & Conditions will be effective only if in writing and signed by an authorized representative of Doorbell. Doorbell will be entitled to injunctive or other equitable relief (without the obligations of posting any bond or surety) in the event of any breach or anticipatory breach by you. Doorbell operates and controls the Doorbell Service from its offices in . The Service is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation. Accordingly, those persons who choose to access the Doorbell Service from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable. These Terms & Conditions (which include and incorporate the Doorbell Privacy Policy) contains the entire understanding, and supersedes all prior understandings, between you and Doorbell concerning its subject matter, and cannot be changed or modified by you. The section headings used in this Agreement are for convenience only and will not be given any legal import.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Disclaimer</h1>
                        <p>Doorbell is not responsible for any content, code or any other imprecision.</p>
                        <br />
                        <p>Doorbell does not provide warranties or guarantees.</p>
                        <br />
                        <p>In no event shall Doorbell be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service. The Company reserves the right to make additions, deletions, or modifications to the contents on the Service at any time without prior notice.</p>
                        <br />
                        <p>The Doorbell Service and its contents are provided &quot;as is&quot; and &quot;as available&quot; without any warranty or representations of any kind, whether express or implied. Doorbell is a distributor and not a publisher of the content supplied by third parties; as such, Doorbell exercises no editorial control over such content and makes no warranty or representation as to the accuracy, reliability or currency of any information, content, service or merchandise provided through or accessible via the Doorbell Service. Without limiting the foregoing, Doorbell specifically disclaims all warranties and representations in any content transmitted on or in connection with the Doorbell Service or on sites that may appear as links on the Doorbell Service, or in the products provided as a part of, or otherwise in connection with, the Doorbell Service, including without limitation any warranties of merchantability, fitness for a particular purpose or non-infringement of third party rights. No oral advice or written information given by Doorbell or any of its affiliates, employees, officers, directors, agents, or the like will create a warranty. Price and availability information is subject to change without notice. Without limiting the foregoing, Doorbell does not warrant that the Doorbell Service will be uninterrupted, uncorrupted, timely, or error-free.</p>
                    </div>
                    <div className="mt-10 max-w-2xl">
                        ...
                        <ul className="mt-4 gap-y-4 flex flex-col ml-8 list-disc">
                            ...
                            <li>Via <Link className={"underline text-primary-dark"} href={"/#contact"}>this</Link> Link</li>
                        </ul>
                    </div>
                </div>
            </div>
